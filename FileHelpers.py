...
def save_spread_to_csv(spread, spread_type, conditions):
    if not os.path.exists(GlobarVars.RESULT_FOLDER):
        os.makedirs(GlobarVars.RESULT_FOLDER)
    output_file = GlobarVars.RESULT_FOLDER + spread_type + '_' + '_'.join(conditions) + '.csv'
