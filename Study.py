...
import GlobarVars
from TDA_API_Request import request_price_history, RequestError
...
def search_near_strike_volatility(underlying_symbol, price, date, put_call):
    ...
    :type option_chain: OptionChain
    """

    if put_call == 'PUT':
        option_chains = GlobarVars.put_chains_backup[underlying_symbol]
    else:
        option_chains = GlobarVars.call_chains_backup[underlying_symbol]
