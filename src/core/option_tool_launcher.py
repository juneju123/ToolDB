...
from src.core import initial_data
from src.helpers import option_db_helper
from src.process import screen_launcher


def execution(symbol_list, conditions, is_live, max_loss, min_profit, min_expectation, prob_of_max_profit,
