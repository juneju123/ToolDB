...
from src.process import simple_screen, spread_screen
import pandas as pd
...
def vertical_screen_launcher(symbol_list, option_chain, conditions, credit_debit,
    ...
    for symbol in tqdm(symbol_list):
        ...
        spread = spread_screen.spread_screen(option_chain[symbol], credit_debit, put_call, max_loss, min_profit,
    ...
    output_file = file_helpers.save_spread_to_csv(spread_result, spread_name + '_spread_result', conditions)
...
def simple_screen_launcher(symbol_list, option_chain, conditions, min_days_to_expiration, max_days_to_expiration,
    ...
    for symbol in tqdm(symbol_list):
        ...
        simple_screen.simple_screen(option_chain[symbol], conditions, min_days_to_expiration, max_days_to_expiration,
